...
namespace RestlessLib.Editor
{
    ...
    public class ExpandableAttributeDrawer : PropertyDrawer
    {
        ...
        {
            SHOW_SCRIPT_FIELD = false;
            INNER_SPACING = 6.0f;
            OUTER_SPACING = 4.0f;
            BACKGROUND_STYLE = BackgroundStyles.HelpBox;
            DARKEN_COLOUR = new Color(0.0f, 0.0f, 0.0f, 0.2f);
            LIGHTEN_COLOUR = new Color(1.0f, 1.0f, 1.0f, 0.2f);
        }
        #endregion
